...
const MembersList = () => {
  ...
  return (
    ...
    <div className="bg-white border  rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll">
      <div className="hidden lg:grid grid-cols-[0.5fr_2fr_2fr_1fr_1fr_1fr_1fr] gap-1    py-3 px-6 border-b ">
        <p>#</p>
        <p> Name</p>
        <p>Email</p>
        <p>Age</p>
      ...
      </div>
      {
        users.map((item,index)=> (
          <div className="flex flex-wrap justify-between max-sm:text-base max-sm:gap-5 lg:grid grid-cols-[0.5fr_2fr_2fr_1fr_1fr_1fr_1fr] gap-1 items-center text-gray-500  py-3 px-6 border-b hover:bg-gray-50"  key={index}>
