...
const Home = () => {
  ...
  return (
    <div className="">
      <div className="min-h-screen bg-gray-900  bg-[url('https://res.cloudinary.com/dkmnkggev/image/upload/v1740474871/h1_hero_y9ypa7.webp')] max-sm:bg-[url('https://res.cloudinary.com/dkmnkggev/image/upload/v1740475629/h1_hero_mobile_mp8hyx.jpg')] bg-fixed  bg-cover    bg-no-repeat font-teko flex items-center justify-center relative  ">
