...
const Home = () => {
  ...
  return (
    <div className="">
      <div className="min-h-screen bg-gray-900  bg-[url('https://res.cloudinary.com/dkmnkggev/image/upload/v1740474871/h1_hero_y9ypa7.webp')] max-sm:bg-[url('/assets/hero/h1_hero_mobile.jpg')] bg-fixed  bg-cover    bg-no-repeat font-teko flex items-center justify-center relative  ">
