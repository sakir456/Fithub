...
const Services = () => {
  const navigate = useNavigate()
    ...
    return (
        <div className="min-h-screen xl:px-48 md:py-48 md:px-32 lg:px-32 sm:px-28 max-sm:px-4 max-sm:py-24  px-9 py-16   mt-16  bg-[url('/public/assets/gallery/section_bg01.png')] bg-fixed  bg-cover   bg-no-repeat font-teko flex justify-center    ">
