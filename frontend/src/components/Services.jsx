...
const Services = () => {
  const navigate = useNavigate()
    ...
    return (
        <div className="h-full xl:px-48 md:py-48 md:px-32 lg:px-32 sm:px-28 max-sm:px-4 max-sm:py-16  px-9 py-16   my-5  bg-[url('/src/assets/gallery/section_bg01.png')] bg-fixed  bg-cover   bg-no-repeat font-teko flex  flex-col gap-24 justify-center  relative  ">
          ...
          <div className="flex flex-wrap gap-8 ">
            {
              ...
              origin-bottom transition-transform duration-500 ease-in-out group-hover:scale-y-100 flex justify-center cursor-pointer gap-2 text-lg   bottom-0 w-full h-14 pt-3 px-3  bg-primary text-white "
              >
