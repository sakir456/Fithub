...
const Footer = () => {
  ...
  return (
    <div className="min-h-screen flex   justify-center items-center    bg-[url('/src/assets/gallery/section_bg03.png')] bg-fixed  bg-cover    bg-no-repeat font-barlow text-white">
