...
const Footer = () => {
  ...
  return (
    <div className="min-h-screen flex   justify-center items-center    bg-[url('/public/assets/gallery/section_bg03.png')] mt-16 bg-fixed  bg-cover    bg-no-repeat font-barlow text-white">
