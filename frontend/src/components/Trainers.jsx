...
const Trainers = () => {
  ...
  return (
    <div className="px-6 py-20 font-teko flex flex-col gap-2 items-center">
    ...
    <p className=" flex flex-wrap md:text-4xl text-2xl sm:text-3xl font-semibold uppercase text-center mt-2 max-sm:mx-2">Our Most Experienced Team Members</p>
   ...
   <div className="   flex flex-wrap justify-center items-center gap-7 pt-5 gap-y-6">
      {
        trainers.map((item, index) => (
          ...
          <div className=" relative group   border border-red-200   w-[320px] h-[450px] max-sm:w-[275px] max-sm:h-[375px] overflow-hidden   cursor-pointer group " >
            ...
            <div className="absolute   transform scale-y-0 
